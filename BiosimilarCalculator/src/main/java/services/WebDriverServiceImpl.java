...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~		
	public void clickwithFieldName(WebElement ele, String field) {
		try {
			// WebDriverWait wait = new WebDriverWait(getDriver(), 15);
//			wait.until(ExpectedConditions.elementToBeClickable(ele));			
			ele.click();
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public int getTableRowCount(List<WebElement> ele, String field) {	
		int bReturn;
		try {
			List<WebElement>  rows = ele;
		    bReturn = rows.size();
	...
	public void verifyExactContent(String actualText, String expectedText, String field) {
		...
		try {
			if (actualText.equalsIgnoreCase(expectedText)) {
				setReport().log(Status.PASS,
						"The text :" + actualText + " matches with the value in " + field + " field",
						screenshotCapture());
			} else {
				setReport().log(Status.FAIL,
						"The text :" + actualText + " did not match with the value in " + field + " field",
						screenshotCapture());
				Driver.failCount++;
			}
		} catch (WebDriverException e) {
