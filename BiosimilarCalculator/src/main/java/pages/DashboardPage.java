...
public class DashboardPage extends WebDriverServiceImpl {
	...
	public DashboardPage addDrugForCalculation_Biosimilar_DrugsDashboardPage(String NDC, String TradeName,
			String CalculatorTypeIntCode, String GroupNameIntCode, String IsOriginator, 
			String Supplier,String GenericName, String ContractPrice, String The_340BPrice, String WACPrice,
		...
		// GroupName
		// select from dropdown
		getDriver().findElement(By.xpath("//kendo-dropdownlist[@textfield='Name']/span/span")).click();// click on that																								// combo
...
*/
	...
	/*	getDriver().findElement(By.xpath("(//kendo-dropdownlist[@textfield='Text']/span/span)[1]")).click();// click on
		...
		if (BiosimilarUseFacility340BPriceAdjustment.equalsIgnoreCase("TRUE")) {
			click(getDriver().findElement(By.xpath("(//td[@kendogridcell]//input)[20]")), "Biosimilar UseFacility 340B PriceAdjustment");
			Thread.sleep(2000);
		}
