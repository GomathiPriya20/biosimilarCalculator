...
// TC_04: Check that Search field with Filter options is getting displayed in the "User Name" and "User Email Address" columns
...
public class TestCase_04 {
	...
	public static void calculator(int iRowNumber, String sDataSheetName)
		...
		new UserlistPage().verifySearchFields_UserName_UserEmailAddress();
	}
}
