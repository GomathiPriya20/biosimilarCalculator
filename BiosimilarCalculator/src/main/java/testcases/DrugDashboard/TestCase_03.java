...
//TC_03:DrugDashboard_Add_ErrorMsg
...
public class TestCase_03 {
	...
	public static void calculator(int iRowNumber, String sDataSheetName)
		...
		new GeneralDashboardPage().clickDrugsDashboardMenu().drugDetail_ErrorMsg_Biosimilar_DrugsDashboardPage(
				...
				DataInputProvider.getCellData_ColName(iRowNumber, "GroupName_IntCode_ErrorMsg", sDataSheetName),
